...
parsed_english_path = r"E:\toanvui-main\scratch\english_problems.json"
...
json_str = content.replace("export const problems = ", "").rstrip(";\n ")
...
json_str = content.replace("export const topics = ", "").rstrip(";\n ")
