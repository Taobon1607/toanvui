"""
Improved DOCX parser v12.
Fixed the 'isupper()' bug where choice lines (A. B. C. D.) were detected as instructions.
"""
...
def parse_docx(paras, topic_id):
    ...
    for p in paras:
        ...
        # PRIORITIZE Choice markers to avoid all-caps choice lines being treated as instructions
